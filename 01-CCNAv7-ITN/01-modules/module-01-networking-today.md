...
## 📖 Lesson Flow
- What is a network (LAN, WAN, Internet, SOHO)
- Client-server vs peer-to-peer
- Network architectures (2-tier / 3-tier)
- Cisco networking ecosystem overview

## 🧠 Key Focus
- Identify network types
- Understand device roles (switch, router, AP)
...
- [Download Packet Tracer File](https://github.com/GRAVITYPulse/ccna-roadmap/blob/main/01-CCNAv7-ITN/02-labs/07-packet-tracer-files/1.5.7%20Packet%20Tracer%20-%20Network%20Representation.pka?raw=true)
- 
## 🔧 Skills Check
